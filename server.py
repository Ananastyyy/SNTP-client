...
class SNTPServer:
    # Поля для построения SNTP пакета
    stratum = 1
    mode = 4
    ...
    # Строим пакет SNTP, упаковывая все нужные значения в бинарную строку
